...
bison -d parser.y
flex scanner.l
gcc -o json2relcsv main.c parser.tab.c lex.yy.c ast.c csv-writer.c symbol_table.c -ly -ll
```
...
```bash
./json2relcsv --print-ast --print-symbol-table --out-dir output_dir < input.json 
```
