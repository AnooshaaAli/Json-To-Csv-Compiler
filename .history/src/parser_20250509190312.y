...
value:
    ...
    | TRUE           { $$ = createBoolNode("bool", 1); $$->hasBool = 1; }
    | FALSE          { $$ = createBoolNode("bool", 0); $$->hasBool = 1; }
...
object:
    LEFT_BRACE members RIGHT_BRACE { 
        $$ = createNode("object"); // create an object node
        addChild($$, $2); // add the members as a child of the object node
    }
  | LEFT_BRACE RIGHT_BRACE         { 
        $$ = createNode("empty_object"); // empty object case
    }
;
